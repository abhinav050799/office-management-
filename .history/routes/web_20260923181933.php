...
route::get('deviceType','deviceType');
});
...
Route::get('circular', 'index')->name('circular');
Route::post('circular/store','add')->name('circular.store');
Route::post('circular/update/{id}', 'update')->name('circular.update');
Route::delete('circular/delete/{id}','delete')->name('circular.dlt');
});

Route::controller(adminController::class)->group(function(){
Route::get('admin/users', 'index')->name('admin_users');
Route::post('admin/registeruser', 'register')->name('adminregisteruser');
Route::post('admin/updateuser/{id}', 'Update')->name('adminUpdateuser');
