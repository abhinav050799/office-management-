...
class UserController extends Controller
{
    ...
    public function dashboard(){
      ...
      $upcominbirthday = $this->getAllBirthday();
        ...
        return view('dashboard', compact('data','attendance','upcominbirthday','leaveTotal','totalleaveTaken'));
    }
...
public function TotalTakenLeave(){
      ...
      $takenLeave = Leave::where('account_id',$account_id)->where('status','Approved');
      
      return $takenLeave['->count('totaldays')'];
}
}
