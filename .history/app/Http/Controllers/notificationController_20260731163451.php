...
class notificationController extends Controller
{
    ...
    public function notificationRead(Request $request)
    {
        ...
        $lastTimeread = DB::table('last_notification_read')->where('account_id',$account_id)->where('last_notification_read_id',$id)->OderBy('id','DESC')->get();
        if(!$lastTimeread){
        ...
        return back()->with('error','Already read this ');
        }
