...
class notificationController extends Controller
{
    ...
    public function NotificationCount(){
        $account_id =  session('account_id');
        $readNotifications  = DB::table('last_notification_read')->where('account_id',$account_id)->pluck('last_notification_read_id')->toArray();
        
        //total notification read vali htaunga 
        $unreadCount = Notification::whereNotIn('id', $readNotifications)->count();
