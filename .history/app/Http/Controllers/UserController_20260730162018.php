...
class UserController extends Controller
{
    ...
    public function dashboard(){
       ...
       $total$this->TotalTakenLeave();
      $upcominbirthday = $this->getAllBirthday();

        return view('dashboard', compact('data','attendance','upcominbirthday','leaveTotal'));
    }
...
public function TotalTakenLeave(){
      ...
      $takenLeave = Leave::where('emp_id',$emp_id)->where('status','approved')->count('totaldays');
