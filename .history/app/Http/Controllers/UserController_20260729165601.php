...
class UserController extends Controller
{
    ...
    public function dashboard(){
       ...
       $attendance = $attend->isTimeinORnot();
        return view('dashboard', compact('data','attendance'));
    }
...
public function getAllBirthday(){
    User::select('id','name', 'dob')
    ->orderByRAW("CASE WHEN(dob) >= MONTH(GETDATE()) THEN MONTH(dob) ELSE MONTH(dob) + 12 END ")->->orderByRaw("DAY(dob)")->get();
}
}
