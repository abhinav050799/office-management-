                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="notification-full-text">
                            ...
                            {{--{!! $data->text !!}--}}
                            <iframe id="frame{{ $data->id }}" style="width:100%;height:700px;border:none;"
                                sandbox="allow-forms"></iframe>

                            <script>
                                document.getElementById("frame{{ $data->id }}").srcdoc = @json($data->text);
                            </script>
                        </div>
...
<script>
    document.querySelector('.notification-card').forEach(function(card){
        card.addEventListener('click', function(){
            let id = this.dataset.id;
            console.log(id);
            fetch("{{ route('notificationread') }}")
        })
    })
</script>