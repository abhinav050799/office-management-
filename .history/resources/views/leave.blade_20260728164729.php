                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($data->status == 'Pending')
                                     ...
                                     @endif
                                <td>
                                    <button class="btn btn-sm btn-primary me-1" title="Edit" data-bs-toggle="modal"
            ...
            <form id="leaveForm" method="POST" action="">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label form-labelModal">Department</label>
                             <input type="text" class="form-control" name="department"  value="{{ $UserAllLeave->designation }}" readonly>
                        ...
                        <div class="col-md-6">
                            <label class="form-label form-labelModal">Name</label>
                            <input type="text" class="form-control" name="name" value="{{ $UserAllLeave->name }}" readonly>
                        </div>

                        <!-- Account ID -->
                        <div class="col-md-6">
                            <label class="form-label form-labelModal">Account Id</label>
                            <input type="text" class="form-control" name="account_id" value="{{ $UserAllLeave->account_id }}" readonly>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label form-labelModal">Leave From</label>
                            <input type="date" class="form-control" name="leavefrom" id="leaveFrom" value="{{ $UserAllLeave->leaveFrom }}" required>
                        </div>
