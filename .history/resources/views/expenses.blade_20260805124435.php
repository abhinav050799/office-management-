    ...
    <div class="card-box">
                        ...
                        <tbody>
                            ...
                            @foreach ($expensise as $expense)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary" type="submit" data-id="{{ $expense->id }}" data-bs-toggle="modal" data-bs-target="#expenseEditModal"><i class="bi bi-pencil"></i></button>
                                        <form>
                                ...
                                <!-- Edit Expense Modal -->
                                 <div class="modal fade" id="expenseEditModal" tabindex="-1" aria-labelledby="leaveModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="expenseForm" method="POST" action="{{ route('expenses.update', $expense->id) }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="product_name" value="{{ $expense->product_name }}" >
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="product_quantity" value="{{ $expense->product_quantity }}">
                            </div>

                            <!-- Product Price -->
                            <div class="col-md-6 mb-2">
                                <label class="form-label form-labelModal">Product Price</label>
                                <input type="number" class="form-control" name="product_price" value="{{ $expense->product_price }}" step="0.01">
                            </div>
                        </div>
