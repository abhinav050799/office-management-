                ...
                <form method="POST" action="{{ route('profileUpdate') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="account_id" value="{{ $user->account_id }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ $user->name || session('username') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" name="email" value="{{ $user->email || session('email') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="mobile" value="{{ $user->name || session('username') }}">
