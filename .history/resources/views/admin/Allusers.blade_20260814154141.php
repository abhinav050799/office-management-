...
<div class="modal fade"
    id="expenseEditModal{{ $userData->id }}"
    tabindex="-1"
    aria-labelledby="expenseEditModalLabel{{ $userData->id }}"
    aria-hidden="true">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group-custom">
                                                                ...
                                                                <input type="text" name="name" id="name"
                                                                    class="form-control" placeholder="Tony Stark" value="{{ $userData->name }}" required>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group-custom">
                                                                ...
                                                                <select class="form-select" name="department"
                                                                    ...
                                                                    <option value="{{ $userData->department }}" disabled selected>
                                                                       {{ $userData->department }}
                                                                    </option>
