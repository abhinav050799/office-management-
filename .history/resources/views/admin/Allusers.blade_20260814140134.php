                        ...
                        <tbody>
                            ...
                            @foreach ($users as $userData)
                                <tr>
                                    ...
                                    <td>{{ $userData->deparment }}</td>
                                    <td>{{ $userData->created_at }}</td>
                                    <td>
                                        <button class="btn btn-primary" type="submit" data-id="{{ $userData->id }}"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title form-labelModal" id="expenseModalLabel">
                                                    <i class="bi bi-calendar-plus"></i> Add User
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <form id="expenseForm" method="POST"
                                                action="{{ route('expenses.update', $userData->id) }}">
                                                @csrf
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                ...
                                                                value="{{ $userData->product_quantity }}">
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 mb-2">
                                                            ...
                                                            <input type="number" class="form-control" name="product_price"
                                                                value="{{ $userData->product_price }}" step="0.01">
                                                        </div>
                                                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body register-modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group-custom register-input-group">
                    ...
                    <!-- Security -->
                    <div class="register-section-title security-title">
                ...
                <div class="register-modal-footer">
                    ...
                    <div class="register-footer-buttons">

                        <button type="button"
                            class="btn btn-secondary register-cancel-btn"
                            data-bs-dismiss="modal">
                        ...
                        <button type="submit"
                            class="btn btn-primary-custom register-submit-btn">
