                ...
                <form method="POST" action="{{ route('profileUpdate') }}" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <div class="profile-image">
                            ...
                            <img src="{{ $data->photo ? asset('images/'.$data) :asset('images/default.png') }}" id="previewImage">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="designation" value="{{ old('designation', $data->role) }}">
