                ...
                <div class="filter-form mb-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            <button class="btn btn-info" id="addLeaveBtn">
                    ...
                    <table id="leaveTable" class="table table-dark table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary me-1" title="Edit" onclick="editLeave(3)">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <button class="btn btn-sm btn-danger" title="Delete" onclick="deleteLeave(3)">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><span class="badge bg-success">Approved</span></td>
                                <td>
                                    <button class="btn btn-sm btn-primary me-1" title="Edit" onclick="editLeave(4)">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <button class="btn btn-sm btn-danger" title="Delete" onclick="deleteLeave(4)">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary me-1" title="Edit" onclick="editLeave(5)">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <button class="btn btn-sm btn-danger" title="Delete" onclick="deleteLeave(5)">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </td>
                            </tr>
