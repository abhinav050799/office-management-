...
<head>
    ...
    <link rel="stylesheet" href="{{ se }}./css/style.css">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end nav-dropdown">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('leaveView') }}">
                                <i class="bi bi-calendar-check me-2" style="color: #5b8cff;"></i>
                                Leave Management
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('expenses') }}">
                                  <i class="bi bi-receipt me-2" style="color: #5b8cff;"></i>
                                Expenses
                            </a>
                        </li>
                        <li>
    <a class="dropdown-item" href="{{ route('circular') }}">
        <i class="bi bi-megaphone me-2" style="color: #5b8cff;"></i>
        Circular
    </a>
</li>
                    </ul>
...
function getNotificationCount(){
    ...
    .then(data => {
        ...
        document.getElementById('notificationBadge').innerHTML = data.count;
