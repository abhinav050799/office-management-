...
body.light-mode .notification-dropdown .dropdown-item {
    color: #1a1a2e;
}

body.light-mode .notification-dropdown .dropdown-item:hover {
    background: #f0f4ff;
}

body.light-mode .notification-dropdown .dropdown-item small {
    color: #999;
}
</style>