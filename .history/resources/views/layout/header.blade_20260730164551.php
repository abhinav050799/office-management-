    ...
    <header class="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                <!-- NOTIFICATION BELL -->
                <div class="dropdown">
                    <a class="text-decoration-none text-light position-relative d-flex align-items-center" href="#"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end notification-dropdown"
                        ...
                        <li>
                            <a class="dropdown-item fw-bold text-center" href="#"
                                style="color: #5b8cff; border-bottom: 1px solid rgba(91,140,255,0.1);">
