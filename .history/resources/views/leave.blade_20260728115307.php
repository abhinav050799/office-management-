                ...
                <div class="filter-form mb-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            <button class="btn btn-info" id="addLeaveBtn" data-bs-toogle="modal"
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" rows="2"
                                placeholder="Enter address during leave">water workers Shivlok colony haridwar</textarea>
                        </div>

                        <!-- Contact No During Leave -->
                        <div class="col-md-12">
                            <label class="form-label">Contact No. During Leave</label>
                            <input type="tel" class="form-control" value="7983034032"
