...
<body>
    ...
    <div id="notificationList">
        @foreach($dataNoti as $dataNot)
        <!-- Sample Notification 1 -->
        <div class="notification-card" data-id="1">
            <div class="card-header-custom">
                <div>
                    <span class="badge-department"><i class="bi bi-diagram-3 me-1"></i>{{ $dataNoti->department }}</span>
                    <span class="badge-role"><i class="bi bi-star me-1"></i>{{ $dataNoti->role }}</span>
                </div>
                <div>
            ...
            <div class="notification-title">🚀 {{ $dataNoti->title }}</div>
            <div class="notification-text">
            {{ $dataNoti->text }} 
            </div>
            <div class="notification-meta">
                <span><i class="bi bi-calendar3"></i> {{\Carbon\Carbon::parse( $dataNoti->created_at )->format('F d,Y')}}</span>
                <span><i class="bi bi-clock"></i>{{\Carbon\Carbon::parse($dataNoti->created_at)->format('h:i A')  }}</span>
