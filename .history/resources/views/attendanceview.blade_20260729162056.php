                ...
                <div class="filter-form mb-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            <button class="btn btn-info" id="addattendBtn" data-bs-toggle="modal"
                                data-bs-target="#attendModal">
                                <i class="bi bi-plus-circle"></i> Add attend
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="attendTable" class="table table-dark table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach ($attendanceData as $attend)
                                ...
                                <tr>
                                    <td>{{ $sno++ }}</td>
                                    <td>{{ $attend->account_id }}</td>
                                    <td>{{ $attend->name }}</td>
                                    <td>{{ $attend->attendfrom }}</td>
                                    <td>{{ $attend->attendto }}</td>
                                    <td>{{$attend->attendpurpose}}</td>
                                    <td>{{ $attend->phone }}</td>
