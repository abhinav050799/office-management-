                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label form-labelModal">Department</label>
                             <input type="text" class="form-control" value="{{ $data->designation }}" readonly>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ $data->account_id }}" readonly>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-control" required>
                                ...
                                <option value="urgentwork" selected>Urgent Work</option>
                                <option value="personalwork">Personal Work</option>
                                <option value="sickleave">Sick Leave</option>
                                <option value="Marketing">Schedule Leave</option>
