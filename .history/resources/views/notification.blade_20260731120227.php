...
<body>
    ...
    <div id="notificationList">
        ...
        <div class="notification-card" data-id="1">
            <div class="card-header-custom">
                <div>
                    <span class="badge-department"><i class="bi bi-diagram-3 me-1"></i> R&D · Engineering</span>
                    <span class="badge-role"><i class="bi bi-star me-1"></i> Manager</span>
                </div>
                <div>
            ...
            <div class="notification-title">🚀 New Feature Release</div>
            <div class="notification-text">
                We're excited to announce the <strong>AI-Powered Dashboard</strong>! 
                <a href="#">Click here</a> to learn more about the new features and improvements.
            </div>
            <div class="notification-meta">
                <span><i class="bi bi-calendar3"></i> July 30, 2026</span>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="rich-text-editor">
                                <div class="rich-text-toolbar">
                                    ...
                                    <button type="button" onclick="insertLink()"><i class="bi bi-link-45deg"></i></button>
                                    <span class="divider"></span>
                                    <button type="button" onclick="clearFormatting()"><i class="bi bi-eraser"></i></button>
                                </div>
                                <textarea id="notificationMessage" name="notificationMessage" placeholder="Write your notification message here... You can use HTML tags like <strong>, <em>, <ul>, <a> etc."></textarea>
                            </div>
                            <small class="text-muted mt-2 d-block">
                                <i class="bi bi-info-circle me-1"></i> HTML tags supported: &lt;strong&gt;, &lt;em&gt;, &lt;ul&gt;, &lt;a&gt;, &lt;br&gt;
                            </small>
                        </div>
                    </div>
    ...
    <script>
        ...
        function insertList() {
            ...
            const text = textarea.value;
            const list = '\n<ul>\n  <li>Item 1</li>\n  <li>Item 2</li>\n</ul>\n';
            textarea.value = text.substring(0, start) + list + text.substring(start);
            textarea.selectionStart = start + list.length;
            textarea.focus();
        }
        ...
        function clearFormatting() {
            ...
            // Simple strip: remove common HTML tags
        ...
        document.getElementById('notificationForm').addEventListener('submit', function(e) {
            ...
            // Validation
            if (!department || !role || !title || !message) {
            ...
            card.setAttribute('data-id', ++notificationCount);
            
            const deptDisplay = department === 'All' ? 'All Departments' : department;
            const deptBadgeClass = department === 'All' ? 'badge-all' : 'badge-department';
            const deptIcon = department === 'All' ? 'bi-globe2' : 'bi-diagram-3';
            const roleDisplay = role === 'All' ? 'All Roles' : role.charAt(0).toUpperCase() + role.slice(1);
            ...
            card.innerHTML = `
                <div class="card-header-custom">
                    <div>
                        <span class="${deptBadgeClass}"><i class="bi ${deptIcon} me-1"></i> ${deptDisplay}</span>
                        <span class="badge-role"><i class="bi bi-star me-1"></i> ${roleDisplay}</span>
                    </div>
                    <div>
                        <button class="btn-delete" onclick="deleteNotification(this)">
                            <i class="bi bi-trash3 me-1"></i> Delete
                ...
                <div class="notification-meta">
                    ...
                    <span><i class="bi bi-eye"></i> Sent to: ${deptDisplay} · ${roleDisplay}</span>
                </div>
            `;
            ...
            btn.innerHTML = '<i class="bi bi-check2-circle me-2"></i> Sent!';
        ...
        // ─── THEME TOGGLE (from your existing code) ───
        // This is here for demo - you already have this in your header
