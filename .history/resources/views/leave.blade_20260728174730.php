                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($data->status == 'Pending')
                                     ...
                                     @endif
                                <td>
                                    <button class="btn btn-sm btn-primary me-1 editBtn" title="Edit" data-bs-toggle="modal"
            ...
            <form id="leaveForm" method="POST" action="">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label class="form-label form-labelModal">Address During Leave</label>
                            <textarea class="form-control" rows="2" name="address" id=""
                                placeholder="Enter address during leave">{{ $data->address }}</textarea>
                        </div>
    ...
    $(document).on('click', '.editBtn', function(){
        ...
        success: function(response){
            if(response.status){
                ...
                $('input[name="leaveType"][value="'+response.data.leavetype+'"]').prop('checked', true);
