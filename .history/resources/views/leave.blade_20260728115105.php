                ...
                <div class="filter-form mb-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            <button class="btn btn-info" id="addLeaveBtn"  data-bs-toogle="modal" data-bs-target="#leaveModal">
                    ...
                    <table id="leaveTable" class="table table-dark table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary me-1" title="Edit" onclick="editLeave(2)">
                                        <i class="bi bi-pencil"></i>
                                    </button>
                                    <button class="btn btn-sm btn-danger" title="Delete" onclick="deleteLeave(2)">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </td>
                            </tr>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="Abhinav Amoli" readonly>
                        </div>

                        <!-- Account ID -->
                        <div class="col-md-6">
                            <label class="form-label">Account Id</label>
                            <input type="text" class="form-control" value="VM/DDN/IT/0057" readonly>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-3 mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="leaveType" id="halfDay" value="Half Day" checked>
                                    <label class="form-check-label" for="halfDay">Half Day</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="leaveType" id="fullDay" value="Full Day">
                                    <label class="form-check-label" for="fullDay">Full Day</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="leaveType" id="complimentary" value="Complimentary">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" rows="2" placeholder="Additional reason if any..."></textarea>
                        </div>

                        <!-- Address During Leave -->
                        <div class="col-md-12">
                            <label class="form-label">Address During Leave</label>
                            <textarea class="form-control" rows="2" placeholder="Enter address during leave">water workers Shivlok colony haridwar</textarea>
                        </div>

                        <!-- Contact No During Leave -->
                        <div class="col-md-12">
                            <label class="form-label">Contact No. During Leave</label>
                            <input type="tel" class="form-control" value="7983034032" placeholder="Enter contact number">
                        </div>
                    </div>
                </div>
