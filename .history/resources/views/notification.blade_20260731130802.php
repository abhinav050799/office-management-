    ...
    * {
    ...
    <div id="notificationList">
        ...
        @foreach($dataNoti as $data)
            ...
            <div class="notification-card"  data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="{{ $data->id }}" data>
    ...
    <!-- Notification Data view -->
     <div id="notificationList">
        ...
        @foreach($dataNoti as $data)
            ...
            <div class="notification-card" data-bs-toggle="modal" data-bs-target="#notificationModal" data-id="{{ $data->id }}" data>
