                            ...
                            @foreach ($circular as $circulars)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{ route('expenses.dlt', $circulars->id) }}">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form id="expenseForm" method="POST"
                                                action="{{ route('expenses.update', $circulars->id) }}">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea class="form-control" name="product_quantity" rows="2">{{ $circulars->text }}</textarea>
                                                        </div>
                                                    </div>
